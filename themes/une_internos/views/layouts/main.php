    ...
    <body>
        ...
        <div id="outer-center" class="ui-layout-center container hide">
                                        ...
                                        . 'class="hintpopover forNewUser">'.$LoginUser.'<span>&nbsp;▼</span></p></div>'
                                           . '<div id="div-foto">'
                                             .   '<div id="foto-name">'
                                                ...
                                                . '<p id="name" style="color:#00c6f4">'.$LoginUser.'</p>'
                                                #. '<p style="color:#873299">'.Yii::app()->session['users']->department.'</p>'
                                                . '<p align="center" style="color:#00c6f4">'.Yii::app()->session['users']->mail.'</p>'
                                             . '</div>'
                                             . '<div>'
                                                    .CHtml::ajaxLink(
                                                        'editar perfil',
            ...
            <div class="ui-layout-center hide" style="padding: 10px; overflow: auto;"> 
                ...
                <div style="width: 99%; margin-left:15px; margin-top: 10px">
                    <?php echo $content; ?>
                </div>
            </div>	
        </div>
