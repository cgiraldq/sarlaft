	...
	setColumns : function(p) {
		...
		return this.each(function(){
			...
			if ( $("#"+IDs.themodal).html() != null ) {
				...
				formdata += "<table border='0' class='EditTable1' id='"+dtbl+"_2'><tbody><tr style='display:block;height:3px;'><td></td></tr><tr><td class='DataTD ui-widget-content'></td></tr><tr><td class='ColButton EditButton'>"+bS+"&#160;"+bC+"</td></tr></tbody></table>";
				p.gbox = "#gbox_"+gID;
