...
class InvokeSoapClient extends CApplicationComponent{
	...
	/**
         ...
         * @return object
         */
	private function getClientInt($ws_url,$options,$setLocation='') {
		...
		try {
				...
				if($this->client == null)
				{
					...
					ini_set('soap.wsdl_cache_ttl',$this->ttl); 
										...
										if($setLocation !='')
										{
											$this->client->__setLocation($setLocation);
										}
				}
				return $this->client;
		}
	...
	/**
         ...
         * @return object
         */
	public function invokeWs($ws_url,$wsMethod,$params=NULL,$options=array(),$keyoptions=array(),$setLocation='')
	{	
		try { 
                        $this->client                           = NULL;
			$wsResponse				= NULL;			
                        ...
                        $this->getClientInt($ws_url,$options,$setLocation);
