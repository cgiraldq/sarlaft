...
/* @var $data MvcUsers */
//echo $this->sincifrar($model->fce_email);
//$correo="cristian.giraldo90@gmail.com";
$correo=$this->sincifrar($model->fce_email);
$host = '200.13.249.167';
...
$mail->SetFrom("Noreplytigo@TigoUne.com", 'Código Ética');
$mail->Subject    = "certificación Lectura Código de ética";
  ...
  </head><div><table width="50%" align="center"><tr><td><img src="images/header-bg-fce.png" ></td></tr>
<tr><td class="sombra">Hola, Te confirmamos que la certificación, lectura y comprensión del Código de ética de <b>'.$this->sincifrar($model->fce_nombre_persona).'</b> ha sido recibida correctamente por el equipo de Compliance, con radicado  No.<b>'. $model->fce_radicado.'</b>.  
