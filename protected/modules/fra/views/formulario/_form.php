...
?>
	...
	?>
		...
		<table width="98%" border="0" cellspacing="1" cellpadding="1"><tbody><tr><td width="50%" align="left"><div><?php setlocale(LC_ALL,"es_ES"); echo utf8_encode(ucfirst(strftime("%A %d de %B del %Y"))); ?></div></td><td width="50%" align="right" style="text-align:right !important;"><a href="index.php?r=fra/formulario/create&logout_user=1">Cerrar sesión</a></td></tr></tbody></table>
		...
		<div align="justify">Como principio general, nuestra política de regalos y atenciones indica que ninguno
		de los directivos, miembros de juntas directivas, colaboradores, proveedores y clientes, así como a aquellos que representen a TigoUne, independientemente del tipo de relación laboral, comercial o jurídica que se tenga establecida, y del nivel jerárquico en las compañías, No deberá dar, recibir u ofrecer elementos o agasajos considerados como Regalos o Atenciones en esta política.<br><br>

Recuerda que los regalos y atenciones recibidos se sortearán entre los colaboradores de la Compañía por eso es importante entregarlo en una de las sedes de tu ciudad.<br>
</div>
		...
		<br />
			...
			?>
					...
					<div class="row">
				<?php echo $form->labelEx($model,'fra_identificacion'); ?>
				<?php echo $form->textField($model,'fra_identificacion',array('maxlength'=>255,'readOnly'=>'readOnly','value'=>$identificacion)); ?>
				<?php echo $form->error($model,'fra_identificacion'); ?>
			</div>
			
			<div class="row">
				<?php echo $form->labelEx($model,'fra_nombre'); ?>
				<?php echo $form->textField($model,'fra_nombre',array('maxlength'=>255,'readOnly'=>'readOnly','value'=>$nombre)); ?>
				<?php echo $form->error($model,'fra_nombre'); ?>
			</div>

		
			
						<div class="row">
				<?php echo $form->labelEx($model,'fra_vicepresidencia'); ?>
				<?php echo $form->textField($model,'fra_vicepresidencia',array('maxlength'=>255,'readOnly'=>'readOnly','value'=>$vicepresidencia)); ?>
				<?php echo $form->error($model,'fra_vicepresidencia'); ?>
			</div>
			
						<div class="row">
				<?php echo $form->labelEx($model,'fra_area'); ?>
				<?php echo $form->textField($model,'fra_area',array('maxlength'=>255,'readOnly'=>'readOnly','value'=>$area)); ?>
				<?php echo $form->error($model,'fra_area'); ?>
			</div>
			
	

			<div class="row">
				<?php echo $form->labelEx($model,'fra_cargo'); ?>
				<?php echo $form->textField($model,'fra_cargo',array('maxlength'=>255,'readOnly'=>'readOnly','value'=>$cargo)); ?>
				<?php echo $form->error($model,'fra_cargo'); ?>
			</div>
			
			<div class="row">
				<?php echo $form->labelEx($model,'fra_email'); ?>
				<?php echo $form->textField($model,'fra_email',array('maxlength'=>255,'readOnly'=>'readOnly','value'=>$email)); ?>
				<?php echo $form->error($model,'fra_email'); ?>
			</div>

			<div class="row">
				<?php echo $form->labelEx($model,'fra_telefono'); ?>
				<?php echo $form->textField($model,'fra_telefono',array('maxlength'=>255,'readOnly'=>'readOnly','value'=>$telefono)); ?>
				<?php echo $form->error($model,'fra_telefono'); ?>
			</div>

			<!--
			<div class="row">
				<?php //echo $form->labelEx($model,'fra_pais_id'); ?>
				<?php //echo $form->dropDownList($model,'fra_pais_id',CHtml::listData(Pais::model()->findAll(array('order'=>'pai_nombre')), 'pai_id', 'pai_nombre'), array('ajax'=>array('type'=>'POST','url'=>CController::createUrl('Formulario/Selectdepartamento'),'update'=>'#'.CHtml::activeId($model,'fra_departamento_id'), 'beforeSend'=>'function() { $("#Formulario_fra_departamento_id").find("option").remove(); $("#Formulario_fra_ciudad_id").find("option").remove(); }' ), 'prompt' => '--Seleccione--' )); ?>
				<?php //echo $form->error($model,'fra_pais_id'); ?>
			</div>

			<div class="row">
				<?php //echo $form->labelEx($model,'fra_departamento_id'); ?>
				<?php //echo $form->dropDownList($model,'fra_departamento_id',array(), array('ajax'=>array('type'=>'POST','url'=>CController::createUrl('Formulario/Selectciudad'),'update'=>'#'.CHtml::activeId($model,'fra_ciudad_id'), 'beforeSend'=>'function(){ $("#Formulario_fra_ciudad_id").find("option").remove(); }' ))); ?>
				<?php //echo $form->error($model,'fra_departamento_id'); ?>
			</div>
			-->

			<div class="row">
				<?php echo $form->labelEx($model,'fra_ciudad'); ?>
				<?php //echo $form->dropDownList($model,'fra_ciudad_id',array(), array('empty'=>'')); ?>
				<?php echo $form->textField($model,'fra_ciudad',array('maxlength'=>255,'readOnly'=>'readOnly','value'=>$ciudad)); ?>
				<?php echo $form->error($model,'fra_ciudad'); ?>
			</div>

	
			<div class="row">
		<?php echo $form->labelEx($model,'fra_sede_entrega'); ?>
		<?php echo $form->dropDownList($model, 'fra_sede_entrega',
    CHtml::listData( Sede::model()->findAll(), 'sedev', 'fullname' ), array('prompt' => '--Seleccione--') );?>
		<?php echo $form->error($model,'fra_sede_entrega'); ?>
	</div>

<div class="row">
				<?php echo $form->labelEx($model,'fra_regalo'); ?>
				<?php echo $form->textField($model,'fra_regalo',array('maxlength'=>255,'value'=>"")); ?>
				<?php echo $form->error($model,'fra_regalo'); ?>
			</div>
			

		<div class="row">
				<?php echo $form->labelEx($model,'fra_detalle_regalo'); ?>
				<?php echo $form->textField($model,'fra_detalle_regalo',array('maxlength'=>255,'value'=>"")); ?>
				<?php echo $form->error($model,'fra_detalle_regalo'); ?>
			</div>


	<div class="row">
				<?php echo $form->labelEx($model,'fra_fecha_entrega'); ?>
				<?php $this->widget('zii.widgets.jui.CJuiDatePicker',array('model' => $model,'attribute' => 'fra_fecha_entrega','options'=>array('showAnim'=>'fold', ), 'htmlOptions'=>array('style'=>'height:20px; width:20%;')));?>
				
				<?php echo $form->error($model,'fra_fecha_entrega'); ?>
			</div>

  
 	<div class="row">
				<?php echo $form->labelEx($model,'fra_nombre_prov'); ?>
				<?php echo $form->textField($model,'fra_nombre_prov',array('maxlength'=>255,'value'=>"")); ?>
				<?php echo $form->error($model,'fra_nombre_prov'); ?>
			</div>

 	<div class="row">
				<?php echo $form->labelEx($model,'fra_contacto_nom'); ?>
				<?php echo $form->textField($model,'fra_contacto_nom',array('maxlength'=>255,'value'=>"")); ?>
				<?php echo $form->error($model,'fra_contacto_nom'); ?>
			</div>


	<div class="row">
				<?php echo $form->labelEx($model,'fra_email_prov'); ?>
				<?php echo $form->textField($model,'fra_email_prov',array('maxlength'=>255,'value'=>"")); ?>
				<?php echo $form->error($model,'fra_email_prov'); ?>
			</div>
			...
			<?php echo $form->hiddenField($model,'fra_radicado',array('value'=>0)); ?>
			
			<?php //echo $form->hiddenField($model,'fra_ciudad_id',array('value'=>1)); ?>
			
			<?php echo $form->hiddenField($model,'fra_empresa_id',array('value'=>$cod_emp)); ?>
			
			<?php //echo $form->hiddenField($model,'fra_tipo_identificacion_id',array('value'=>0)); ?>
			
			<?php //echo $form->hiddenField($model,'fra_prueba',array('value'=>0)); ?>

			<?php echo $form->hiddenField($model,'fra_estado_id',array('value'=>1)); ?>

			<?php echo $form->hiddenField($model,'fra_usuario_id',array('value'=>1)); ?>
