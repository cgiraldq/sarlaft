...
class FepModule extends CWebModule
{
  /**
  ...
  public function init()
  {
    $this->setImport(array(
      'fep.models.*',
      'fep.components.events.*',
      'fep.particularFunctions.particularFunction',
    ));  
    ...
    $this->assetsFolder = Yii::app()->assetManager->publish(
      Yii::getPathOfAlias('application.modules.fep.assets')
    );
