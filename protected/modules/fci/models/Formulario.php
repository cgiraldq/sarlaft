 ...
 * @property string $fci_jefe_inmediato
 ...
 * @property string $fci_observaciones
 * @property string $fci_declara_conflicto
 * @property string $fci_nombre_persona_conflicto
 * @property string $fci_tipo_identificacion_persona_conflicto_id
...
class Formulario extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('fci_nombre_persona,fci_jefe_inmediato,fci_identificacion_persona', 'required', 'on' => 'insert'),
			array('fci_nombre_persona,fci_jefe_inmediato,fci_identificacion_persona,fci_empresa_id,fci_tipo_identificacion_id,fci_pais_id,fci_departamento_id,fci_ciudad_id,fci_email,fci_telefono,fci_existe_conflicto,fci_declara_conflicto,fci_nombre_persona_conflicto,fci_tipo_identificacion_persona_conflicto_id,fci_observaciones,fci_identificacion_persona_conflicto,fci_parentesco,fci_nombre_empresa_conflicto,fci_identificacion_empresa_conflicto,fci_actividad_empresa_conflicto,fci_declaracion_conflicto,fci_estado_id', 'safe'),
