            ...
            switch ($_POST['type']) {
                case 'insert':
                    if ($rowRecordSetPermission['insert_']) {
						...
						//echo $table;					echo "--".var_dump($arrFields);echo "--".$arrValues;die;
                        $rta = $objAjax->insert($table, $arrFields, $arrValues);
                        if ($rta == 1) {
                            echo 1;
                        } /*else {
                            echo 0;
...
//var_dump($_POST);die;
					...
					//echo $table;					echo "--".var_dump($arrSql);echo "--".$where;die;
					
                        $rta = $objAjax->update($table, $arrSql, $where);
                        if ($rta == 1) {
                            echo 1;
                        } else {
                            echo 0;
