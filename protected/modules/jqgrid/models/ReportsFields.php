...
class ReportsFields extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('report_id, table_field, field, alias, label, field_find, align, field_type_id, option_list, select_sql, field_id_list, field_desc_list, select_complex, function_aggregate, foreign_table, foreign_table_field_id, foreign_table_desc, select_filter, comparison, order_by, group_by, field_where, show_in_grid, group_header, group_header_columns, frozen_column, order_field, width_column, editable, required, formatter, format_options, edit_options, summary_type, summary_tpl, formoptions, editrules, search, searchrules, creadopor, fechacreacion, modificadopor, fechamodificacion', 'filter', 'filter'=>'trim'),
			array('report_id, table_field, field, alias, label', 'required'),
			array('report_id, field_type_id, select_complex, group_by, field_where, show_in_grid, group_header_columns, frozen_column, order_field, width_column, editable, required, search', 'numerical', 'integerOnly'=>true),
			array('table_field, field_find, field_id_list, foreign_table_field_id, formatter, summary_type, summary_tpl, formoptions, creadopor, modificadopor', 'length', 'max'=>100),
