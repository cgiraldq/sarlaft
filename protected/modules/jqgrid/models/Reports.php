...
class Reports extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('report, description, host, bd, ppal_table, field_key, sql_query, toolbarfilter, show_title, toppager, width, edit_inline, edit, insert_, delete_, status, creadopor, fechacreacion, modificadopor, fechamodificacion', 'filter', 'filter'=>'trim'),
			array('report, description, ppal_table, field_key', 'required'),
			array('toolbarfilter, show_title, toppager, width, edit_inline, edit, insert_, delete_, status', 'numerical', 'integerOnly'=>true),
			...
			array('report_id, report, description, host, bd, ppal_table, field_key, sql_query, toolbarfilter, show_title, toppager, width, edit_inline, edit, insert_, delete_, status, creadopor, fechacreacion, modificadopor, fechamodificacion', 'safe', 'on'=>'search'),
		);
	}
