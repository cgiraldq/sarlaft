			...
			{ 
				...
				//	}else{
					...
					foreach ($this->columns['name'] as $key => $name){
						...
						'fci_identificacion_persona', 'fci_nombre_persona', 'fci_email', 'fci_telefono', 'fci_nombre_persona_conflicto', 'fci_identificacion_persona_conflicto', 'fci_identificacion_persona_con', 'fci_parentesco', 'fci_nombre_empresa_conflicto', 'fci_identificacion_empresa_conflicto', 'fci_identificacion_empresa_con', 'fci_actividad_empresa_conflicto', 'fci_actividad_empresa_conflict', 'fci_declaracion_conflicto', 'fci_visitante', 'creadopor', 'modificadopor',
						'fce_identificacion_persona', 'fce_nombre_persona', 'fce_email', 'fce_telefono', 'fce_visitante', 'creadopor', 'modificadopor','fce_vicepresidencia','fce_area','fce_cargo',
						'hdata_identificacion_persona', 'hdata_nombre_persona', 'hdata_email', 'hdata_telefono', 'hdata_visitante', 'creadopor', 'modificadopor','hdata_vicepresidencia','hdata_area','hdata_cargo'
						);
						
						//SE QUITO DEL IF YA QUE NO SE ENCRIPTA POR PROBLEMAS AL CONFULTAR PARA EL DESPLEGABLE DEL FORMULARIO
						//if($alias=='for_radicado' || 
						
						if(in_array($alias, $arrCifrados))
