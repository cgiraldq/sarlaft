...
/**
 * This is the model class for table "tbl_reports_sessions".
 *
 * The followings are the available columns in table 'tbl_reports_sessions':
 * @property integer $id
 ...
 */
class ReportsSessions extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('report_id, username, session, creadopor, fechacreacion, modificadopor, fechamodificacion', 'filter', 'filter'=>'trim'),
			array('report_id, username', 'required'),
			array('report_id', 'numerical', 'integerOnly'=>true),
			array('username, creadopor, modificadopor', 'length', 'max'=>100),
			array('session, fechacreacion, fechamodificacion', 'safe'),
			...
			array('id, report_id, username, session, creadopor, fechacreacion, modificadopor, fechamodificacion', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ReportsSessions the static model class
	 */
