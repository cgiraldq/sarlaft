...
#texto_peq{
	...
	?>
		...
		Tigo está comprometida con la generación de valor a sus grupos de interés en un marco de sostenibilidad empresarial, donde la ética, la transparencia y el respeto por la ley son pilares fundamentales para generar relaciones de confianza con sus Proveedores y demás partes interesadas.<br><br>
...
?>
	...
	<br>
							...
							if(isset($_GET["id"]) && $_GET["id"]!=""){
								...
								$enlace='<legend style="text-align: center;"><h3>Aceptación</h3><span style="font-size: 15px; "><a href="index.php?r=ccp/formulario/create&st=1&username=proveedor&password=proveedor&loginForm=1" style="text-decoration: none;">Código de conducta de proveedores Tigo</b>';
							}
							?>
