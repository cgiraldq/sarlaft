    ...
    <head>
		...
		<script type="text/javascript">  
			function showComplemento() {
				if(document.getElementById('Formulario_ccp_complemento').checked)
...
function validarFechaMenor(date1,date2){
			...
			function validaFechaOcurrencia() {
				//setInterval("", 3000);
				var fecIni = document.getElementById('Formulario_ccp_fecha_declaracion').value;
				
				/*if(!validarFechaMenorActual(fecIni)) {
					alert('La fecha no puede ser superior a la fecha actual');
					document.getElementById('Formulario_ccp_fecha_declaracion').value = '';
				}*/
			}

				function validaFechaInicio() {
				//setInterval("", 3000);
				var fecIni = document.getElementById('Formulario_ccp_fecha_ini_even').value;
				var fecFin = document.getElementById('Formulario_ccp_fecha_fin_even').value;
				
				/*if(!validarFechaMenorActual(fecIni)) {
					alert('La fecha no puede ser superior a la fecha actual');
					document.getElementById('Formulario_ccp_fecha_ini_even').value = '';
				}*/
				...
				/*if(!validarFechaMenorActual(fecFin)) {
					alert('La fecha no puede ser superior a la fecha actual');
					document.getElementById('Formulario_ccp_fecha_fin_even').value = '';
				}*/
    ...
    <body>
		...
		*/
		echo '<div class="ce" style="padding: 10px 40px 10px 40px; ">';
			echo '<img src="../../images/header-bg-ccp.jpg" border="0" class="img-header" />';
			echo $content;
		echo '</div>';
		?>
