<?php
	...
	$user_log=$_SESSION['login_user_fci'];
?>
	...
	?>
		...
		<div><?php echo $nombre; ?>, Certifico haber recibido, leído y comprendido el Manual de  Conflicto de Intereses y me obligo a cumplir con sus términos y condiciones.</div>
		<br />
		...
		<div id="form_conflicto">
			...
			<div class="row">
				...
				<?php echo $form->textField($model,'fci_nombre_persona',array('maxlength'=>255,'readOnly'=>'readOnly','value'=>$nombre)); ?>
				<?php echo $form->error($model,'fci_nombre_persona'); ?>
			</div>

			<div class="row">
				<?php echo $form->labelEx($model,'fci_identificacion_persona'); ?>
				<?php echo $form->textField($model,'fci_identificacion_persona',array('maxlength'=>255,'readOnly'=>'readOnly','value'=>$identificacion)); ?>
				<?php echo $form->error($model,'fci_identificacion_persona'); ?>
			</div>

			<div class="row">
				<?php echo $form->labelEx($model,'fci_empresa_id'); ?>
				<?php echo $form->textField($model,'fci_empresa_id',array('maxlength'=>255,'readOnly'=>'readOnly','value'=>$empresa)); ?>
				<?php echo $form->error($model,'fci_empresa_id'); ?>
			</div>
			
			<div class="row">
				<?php echo $form->labelEx($model,'fci_email'); ?>
				<?php echo $form->textField($model,'fci_email',array('maxlength'=>255,'readOnly'=>'readOnly','value'=>$email)); ?>
				<?php echo $form->error($model,'fci_email'); ?>
			</div>

			<div class="row">
				<?php echo $form->labelEx($model,'fci_telefono'); ?>
				<?php echo $form->textField($model,'fci_telefono',array('maxlength'=>255,'readOnly'=>'readOnly','value'=>$telefono)); ?>
			...
			<div class="row">
				...
				<?php echo $form->textField($model,'fci_ciudad_id',array('maxlength'=>255,'readOnly'=>'readOnly','value'=>$ciudad)); ?>
			...
			<?php echo $form->hiddenField($model,'fci_empresa_id',array('value'=>2)); ?>
