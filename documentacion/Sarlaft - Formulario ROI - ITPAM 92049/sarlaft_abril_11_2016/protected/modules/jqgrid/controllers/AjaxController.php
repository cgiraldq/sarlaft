                                        ...
                                        if ($rowRecordSetPermission['insert_']) {
                                            ...
                                            if($_POST['oper'] == 'add'){ 
												...
												$arrCifrados = array('for_nombre_persona', 'for_identificacion_persona', 'for_complemento_id', 'for_sucursal_operacion', 'for_direccion', 'for_telefono', 'for_codigo_postal', 'for_oficina', 'for_grupo_interes_otro', 'for_tipo_operacion_otro', 'for_persona', 'for_observacion', 'for_producto_otro', 'for_reportante_nombre', 'for_reportante_identificacion', 'for_reportante_correo', 'for_file', 'for_visitante', 'fle_nombre_persona', 'fle_descripcion_consulta', 'fle_reportante_nombre', 'fle_otros_datos_contacto', 'fle_visitante', 'fci_identificacion_persona', 'fci_nombre_persona', 'fci_email', 'fci_telefono', 'fci_nombre_persona_conflicto', 'fci_identificacion_persona_conflicto', 'fci_parentesco', 'fci_nombre_empresa_conflicto', 'fci_identificacion_empresa_conflicto', 'fci_actividad_empresa_conflicto', 'fci_declaracion_conflicto', 'fci_visitante', 'creadopor', 'modificadopor');
                                                    ...
                                                    {
                                                            if(in_array($key, $arrCifrados)) 
																$valor = Controller::cifrar($valor);
                                                    ...
                                                    if(is_array(Yii::app()->session['extraParamsInsert'])){
                                                        foreach (Yii::app()->session['extraParamsInsert'] as $campo => $myvalue) {
															...
															if(in_array($campo, $arrCifrados)) 
																$myvalue = Controller::cifrar($myvalue);
