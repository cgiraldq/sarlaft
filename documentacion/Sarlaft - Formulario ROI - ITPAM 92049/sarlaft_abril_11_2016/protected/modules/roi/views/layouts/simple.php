    ...
    <head>
		...
		<script type="text/javascript">  
			function showComplemento() {
				if(document.getElementById('Formulario_for_complemento').checked)
			...
			function validaFechaInicio() {
				//setInterval("", 3000);
				var fecIni = document.getElementById('Formulario_for_fecha_inicio').value;
				var fecFin = document.getElementById('Formulario_for_fecha_fin').value;
				
				if(!validarFechaMenorActual(fecIni)) {
					alert('La fecha no puede ser superior a la fecha actual');
					document.getElementById('Formulario_for_fecha_inicio').value = '';
				}
			...
			function validaFechaFin() {
				...
				if(!validarFechaMenorActual(fecFin)) {
					alert('La fecha no puede ser superior a la fecha actual');
					document.getElementById('Formulario_for_fecha_fin').value = '';
				}
