...
#button:hover {
  ...
  cursor: pointer;
	...
	<div align="justify">La consulta de coincidencias retorna los resultados de los últimos registros enviados por medio de este formulario,<br>
		Los resultados obtenidos estarán disponibles en los horarios de:
...
17:30	</div>
	...
	<div class="row buttons">
		<br /><?php echo CHtml::submitButton($model->isNewRecord ? 'Enviar' : 'Save', array('autocomplete'=>'false' ) ); ?><spa id="button" onclick="window.location.href='index.php?r=consulta/formulario/consulta&st=1'">Consultar coincidencias</span>
	</div>
