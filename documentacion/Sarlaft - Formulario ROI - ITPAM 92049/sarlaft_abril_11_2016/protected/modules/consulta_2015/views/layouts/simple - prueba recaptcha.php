    ...
    <head>
		...
		<script type="text/javascript">  
			function showComplemento() {
				if(document.getElementById('Formulario_consulta_complemento').checked)
			...
			function validaFechaOcurrencia() {
				//setInterval("", 3000);
				var fecIni = document.getElementById('Formulario_consulta_fecha_ocurrencia').value;
				
				if(!validarFechaMenorActual(fecIni)) {
					alert('La fecha no puede ser superior a la fecha actual');
					document.getElementById('Formulario_consulta_fecha_ocurrencia').value = '';
				}
			}
