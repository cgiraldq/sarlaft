...
class Formulario extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            //array('fce_nombre_persona,fce_area,fce_cargo,fce_identificacion_persona', 'required', 'on' => 'insert'),
			array('fce_empresa_id,fce_tipo_identificacion_id,fce_pais_id,fce_departamento_id,fce_ciudad_id,fce_email,fce_telefono,fce_estado_id', 'safe'),
