...
class Formulario extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('for_radicado,for_empresa_id,for_tipo_identificacion_id,for_identificacion_persona,for_nombre_persona,for_pais_id,for_departamento_id,for_ciudad_id,for_grupo_interes_id,for_tipo_operacion_id,for_observacion,for_fecha_inicio,for_fecha_fin,for_producto_id', 'required', 'on' => 'insert'),
			array('for_complemento,for_complemento_id,for_sucursal_operacion,for_direccion,for_telefono,for_codigo_postal,for_grupo_interes_otro,for_tipo_operacion_otro,for_producto_otro,for_reportante_nombre,for_reportante_tipo_identificacion_id,for_reportante_identificacion,for_reportante_correo,for_prueba,for_estado_id,for_usuario_id','length', 'max'=>250, 'on'=>'insert'),
