...
class UsersRoles extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('rol, username, creadopor, fechacreacion, modificadopor, fechamodificacion', 'filter', 'filter'=>'trim'),
			array('rol, username', 'required'),
			array('rol, username, creadopor, modificadopor', 'length', 'max'=>100),
			...
			array('id, rol, username, creadopor, fechacreacion, modificadopor, fechamodificacion', 'safe', 'on'=>'search'),
		);
	}
