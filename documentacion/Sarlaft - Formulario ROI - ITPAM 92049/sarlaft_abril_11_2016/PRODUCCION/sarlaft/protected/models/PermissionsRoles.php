 ...
 * @property Controller $controller0
...
class PermissionsRoles extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'controller0' => array(self::BELONGS_TO, 'Controller', 'controller'),
			'action0' => array(self::BELONGS_TO, 'Action', 'action'),
		);
	}
	...
	public function search($pagination = array( 'pageSize'=>10))
	{
		...
		$criteria->compare('fechamodificacion',$this->fechamodificacion,true);
               $criteria->with = array(               			'controller0'=>array('select'=>'controller_ir'),               			'action0'=>array('select'=>'action_id'),                          
               );           
                $sort = new CSort();
